...
function addNewMP($query)
{
    ...
    if ($leader_id == null) {
        ...
        ";
        return false; // Menghentikan eksekusi kode selanjutnya
    }

    $query = "INSERT INTO monitoring (project_name, client_name, leader_id, start_date, end_date, progress) VALUES ('$project_name', '$client_name', '$leader_id', '$start_date', '$end_date', '$progress')";
